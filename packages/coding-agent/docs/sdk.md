...
```typescript
import { AuthStorage, createAgentSession, ModelRegistry, SessionManager } from "@ch1nyzzz/pi-coding-agent";
...
```bash
npm install @ch1nyzzz/pi-coding-agent
```
...
```typescript
import { createAgentSession, SessionManager } from "@ch1nyzzz/pi-coding-agent";
...
The `Agent` class (from `@ch1nyzzz/pi-agent-core`) handles the core LLM interaction. Access it via `session.agent`.
...
```typescript
import { getModel } from "@ch1nyzzz/pi-ai";
...
```typescript
import { createAgentSession, DefaultResourceLoader } from "@ch1nyzzz/pi-coding-agent";
...
```typescript
import { createAgentSession } from "@ch1nyzzz/pi-coding-agent";
...
import { createAgentSession, defineTool } from "@ch1nyzzz/pi-coding-agent";
...
```typescript
import type { InlineExtension } from "@ch1nyzzz/pi-coding-agent";
...
```typescript
import { createEventBus, DefaultResourceLoader } from "@ch1nyzzz/pi-coding-agent";
...
```typescript
import { createAgentSession, SettingsManager, SessionManager } from "@ch1nyzzz/pi-coding-agent";
