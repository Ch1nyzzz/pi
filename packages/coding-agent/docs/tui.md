...
**Source:** [`@ch1nyzzz/pi-tui`](https://github.com/earendil-works/pi-mono/tree/main/packages/tui)
...
```typescript
import { CURSOR_MARKER, type Component, type Focusable } from "@ch1nyzzz/pi-tui";
...
```typescript
import { Container, type Focusable, Input } from "@ch1nyzzz/pi-tui";
...
Import from `@ch1nyzzz/pi-tui`:

```typescript
import { Text, Box, Container, Spacer, Markdown } from "@ch1nyzzz/pi-tui";
```
...
```typescript
import { matchesKey, Key } from "@ch1nyzzz/pi-tui";
...
```typescript
import { visibleWidth, truncateToWidth } from "@ch1nyzzz/pi-tui";
...
```typescript
import { getMarkdownTheme } from "@ch1nyzzz/pi-coding-agent";
import { Markdown } from "@ch1nyzzz/pi-tui";
...
For letting users pick from a list of options. Use `SelectList` from `@ch1nyzzz/pi-tui` with `DynamicBorder` for framing.

```typescript
import type { ExtensionAPI } from "@ch1nyzzz/pi-coding-agent";
import { DynamicBorder } from "@ch1nyzzz/pi-coding-agent";
import { Container, type SelectItem, SelectList, Text } from "@ch1nyzzz/pi-tui";
...
```typescript
import { BorderedLoader } from "@ch1nyzzz/pi-coding-agent";
...
For toggling multiple settings. Use `SettingsList` from `@ch1nyzzz/pi-tui` with `getSettingsListTheme()`.

```typescript
import { getSettingsListTheme } from "@ch1nyzzz/pi-coding-agent";
import { Container, type SettingItem, SettingsList, Text } from "@ch1nyzzz/pi-tui";
...
import { matchesKey, truncateToWidth } from "@ch1nyzzz/pi-tui";
