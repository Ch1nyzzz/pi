...
```typescript
import type { ExtensionAPI } from "@ch1nyzzz/pi-coding-agent";
...
| Package | Purpose |
|---------|---------|
| `@ch1nyzzz/pi-coding-agent` | Extension types (`ExtensionAPI`, `ExtensionContext`, events) |
| `typebox` | Schema definitions for tool parameters |
| `@ch1nyzzz/pi-ai` | AI utilities (`StringEnum` for Google-compatible enums) |
| `@ch1nyzzz/pi-tui` | TUI components for custom rendering |
...
```typescript
import { isToolCallEventType } from "@ch1nyzzz/pi-coding-agent";
...
```typescript
import { isBashToolResult } from "@ch1nyzzz/pi-coding-agent";
...
```typescript
import { createLocalBashOperations } from "@ch1nyzzz/pi-coding-agent";
...
```typescript
import { CONFIG_DIR_NAME, type ExtensionAPI } from "@ch1nyzzz/pi-coding-agent";
...
```typescript
import { SessionManager } from "@ch1nyzzz/pi-coding-agent";
...
```typescript
import type { AutocompleteItem } from "@ch1nyzzz/pi-tui";
...
```typescript
import { Box, Text } from "@ch1nyzzz/pi-tui";
...
```typescript
import { withFileMutationQueue } from "@ch1nyzzz/pi-coding-agent";
...
import { Type } from "typebox";
import { StringEnum } from "@ch1nyzzz/pi-ai";
import { Text } from "@ch1nyzzz/pi-tui";
...
**Important:** Use `StringEnum` from `@ch1nyzzz/pi-ai` for string enums. `Type.Union`/`Type.Literal` doesn't work with Google's API.
...
```typescript
import { createReadTool, createBashTool, type ReadOperations } from "@ch1nyzzz/pi-coding-agent";
...
```typescript
import { createBashTool } from "@ch1nyzzz/pi-coding-agent";
...
```typescript
import { keyHint } from "@ch1nyzzz/pi-coding-agent";
...
```typescript
import { Text, Component } from "@ch1nyzzz/pi-tui";
...
```typescript
import { CustomEditor, type ExtensionAPI } from "@ch1nyzzz/pi-coding-agent";
import { matchesKey } from "@ch1nyzzz/pi-tui";
...
```typescript
import { highlightCode, getLanguageFromPath } from "@ch1nyzzz/pi-coding-agent";
