...
Pi bundles core packages for extensions and skills. If you import any of these, list them in `peerDependencies` with a `"*"` range and do not bundle them: `@ch1nyzzz/pi-ai`, `@ch1nyzzz/pi-agent-core`, `@ch1nyzzz/pi-coding-agent`, `@ch1nyzzz/pi-tui`, `typebox`.
