import { createAssistantMessageEventStream, Type } from "@ch1nyzzz/pi-ai";
import { complete, getModel, getProviders } from "@ch1nyzzz/pi-ai/compat";
import {
	Agent,
	bashExecutionToText,
	convertToLlm,
